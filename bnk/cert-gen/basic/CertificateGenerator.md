...
one server certificate/key pairs,
and multiple client certificate/key pairs signed by it :
...
You can verify the generated client and server certificates against the generated CA one with
    ...
    make verify CLIENT_CERTS= <no. of generated certificates that needs to be verified>

    Example: make verify CLIENT_CERTS=5
