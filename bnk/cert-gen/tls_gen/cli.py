...
def build_parser():
    p = OptionParser(usage = "usage: %prog [options] (generate|clean|regenerate|verify|info|gen_extension)")
    ...
    p.add_option( "--client-certs", dest = "client_certs", action = "store",
                 help = "How many certificates should be generated",
                 type = "int", default = 0)
    return p
